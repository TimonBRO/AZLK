...
function selectDate() {
	element.classList.contains("block_GBAZLK") ? (element.classList.toggle("block_GBAZLK"), element.classList.add("block_AZLK")) : element.classList.contains("block_AZLK") && (element.classList.toggle("block_AZLK"), element.classList.add("block_GBAZLK"))
}
var slideIndex = 1;
